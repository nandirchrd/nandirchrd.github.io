            ...
            <div className="description">
              ...
              <Fade triggerOnce delay={4000}>
                <p style={{ maxWidth: 800 }}>
                  My passion for photography compels me to capture the essence
                  of the world through my lens, and I am dedicated to
                  continually refining and perfecting my craft.
                </p>
              </Fade>
            </div>
        ...
        <div className="container">
          ...
          <Fade triggerOnce duration={1000} delay={200}>
            {photos.isLoading ? (
              ...
              <button
                className="load-more"
                onClick={() => handleLoadMore(setPhotos)}>
                Load More
              </button>
            ) : (
              ""
