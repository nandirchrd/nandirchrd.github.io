    ...
    <section className="about-portofolio">
        <div className="container">
            ...
            <div className="description">
                <h3>NANDI SETIADI</h3>
                <p>Nama saya Nandi Setiadi, berusia 22 tahun. Saya bersemangat untuk terus belajar dalam dunia kerja. Meskipun pengalaman saya terbatas, tetapi saya memiliki motivasi tinggi untuk tumbuh, berkembang, dan berkontribusi secara signifikan bagi perusahaan Anda.</p>
            </div>
            <hr className="line"/>
        </div>
    </section>
            ...
            <ul className="circle">
                ...
                <li>
                    ...
                    <div id="unemployed" className='hidden'>
                        ...
                        <ul>
                           <li>Youtube: <a href="https://youtube.com/@silentdev224" target="_blank">Coding</a>, <a href="https://youtube.com/@nandirichard" target="_blank">Guitar</a>, <a href="https://moonely.blogspot.com" target="_blank">Journals</a></li>
